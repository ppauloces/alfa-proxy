    ...
    <section class="relative flex items-start justify-center overflow-hidden pt-32"
        ...
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
                ...
                <div class="text-left">
                    <!-- SVG Animado -->
                    <svg id="alfaLogo" viewBox="0 0 600 250" class="inline-block transform -translate-x-7 translate-y-5" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                    ...
                    <h1 class="text-white font-bold mb-6"
                        ...
                        Proxies Premium de <br><span style="color: #e8eef5;">Alta Performance</span>
                    </h1>
                    <p class="text-white text-xl mb-8"
                        style="font-family: 'Gilroy', sans-serif; font-weight: 400; max-width: 550px; opacity: 0.95;">
                        Velocidade, segurança e preços acessíveis. <br>Conquiste resultados com a <strong
                            style="color: #e8eef5;">AlfaProxy</strong>
                    </p>
