...
<div class="flex flex-col gap-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <a href="https://wa.me/5511921655260" target="_blank" class="group bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm hover:border-green-500 transition-all">
            ...
            <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">WhatsApp</p>
                <p class="text-lg font-black text-slate-900 mb-2">+55 11 92165-5260</p>
