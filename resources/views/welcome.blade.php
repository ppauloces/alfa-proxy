...
<head>
    ...
    <title>ProxyAlfa - Proxies SOCKS5 Premium</title>
    ...
    <header class="bg-white shadow-sm">
        <div class="container mx-auto px-4 py-6 flex justify-between items-center">
            ...
            <nav class="hidden md:flex space-x-8">
                <a href="{{ route('inicial') }}" class="text-gray-600 hover:text-blue-500 font-medium">Início</a>
                <a href="{{ route('inicial') }}" class="text-gray-600 hover:text-blue-500 font-medium">Planos</a>
                <a href="{{ route('inicial') }}" class="text-gray-600 hover:text-blue-500 font-medium">API</a>
